  ...
  return (
    <div className="flex-1 flex flex-col bg-slate-50 h-screen animate-in slide-in-from-right duration-300">
      <div className="flex items-center justify-between p-4 bg-white border-b border-slate-200 shadow-sm z-10 flex-shrink-0">
        <h1 className="text-xl font-semibold text-slate-900">New Quote</h1>
        <Button
          variant="ghost"
          size="icon"
            ...
            <Card className="overflow-hidden border-slate-200 shadow-sm">
              <CardContent className="p-0">
                        ...
                        <tr key={item.id} className="group hover:bg-slate-50/50 transition-colors">
                          ...
                          <td className="px-6 py-4">
                            <Select value={item.itemId} onValueChange={(v) => handleItemChange(index, v)}>
                              <SelectTrigger className="border-0 bg-transparent hover:bg-white focus:bg-white shadow-none hover:shadow-sm transition-all h-auto py-2">
                ...
                <div className="p-4 border-t border-slate-100 bg-slate-50/30">
                  <Button variant="link" className="text-blue-600 hover:text-blue-700 h-auto p-0 font-medium" onClick={addNewRow}>
